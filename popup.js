  ...
  if (tab) {
    ...
    if (!isPdf) {
      ...
      chrome.scripting.executeScript({
        ...
        const filteredLinks = AipExtractor.filterAipLinks(mainFrameUrl, aggregatedLinks);
        ...
        const resolvePromises = filteredLinks.map(AipExtractor.resolveAipHtmlToPdfLinks);
